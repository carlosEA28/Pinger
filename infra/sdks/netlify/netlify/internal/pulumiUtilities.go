...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^github.com/pulumi/pulumi-terraform-provider/sdks/go/netlify/netlify(/v\\d+)?")
...
func PkgGetPackageRef(ctx *pulumi.Context) (string, error) {
	return ctx.GetOrRegisterPackageRef("netlify:0.4.3", func() (*pulumirpc.RegisterPackageRequest, error) {
		parameter, err := base64.StdEncoding.DecodeString("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL25ldGxpZnkvbmV0bGlmeSIsInZlcnNpb24iOiIwLjQuMyJ9fQ==")
		if err != nil {
			return nil, err
		}
