module github.com/carlosEA28/pinger
...
require github.com/pulumi/pulumi-terraform-provider/sdks/go/netlify v0.0.0

require github.com/pulumi/pulumi-command/sdk v1.2.1
